...
std::time_t convertToUnixTimestamp(uint64 dateValue)
{
    ...
    std::tm tmStruct = {};
    tmStruct.tm_year = static_cast<int>(year - 1900); // Cast to int
    tmStruct.tm_mon = static_cast<int>(month - 1);    // Cast to int
    tmStruct.tm_mday = static_cast<int>(day);         // Cast to int
